...
export interface PaymentModesPageProps {
  data?: PaymentMode[];
...
export function PaymentModesPage({ data: propData, onAdd, onUpdate, onDelete }: PaymentModesPageProps) {
  ...
  return (
    <div>
      ...
      >
        ...
        {modal && (
          <Modal title={`${modal.mode === "add" ? "Add" : "Edit"} — Payment Modes`} onClose={() => setModal(null)}>
        ...
        {toDelete && (
          <Modal title="Delete — Payment Modes" onClose={() => setToDelete(null)}>
