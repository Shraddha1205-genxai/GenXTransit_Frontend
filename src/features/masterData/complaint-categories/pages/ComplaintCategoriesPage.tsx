...
export interface ComplaintCategoriesPageProps {
...
export function ComplaintCategoriesPage({ data: propData, onAdd, onUpdate, onDelete }: ComplaintCategoriesPageProps) {
