...
export interface TaxConfigurationsPageProps {
...
export function TaxConfigurationsPage({ data: propData, onAdd, onUpdate, onDelete }: TaxConfigurationsPageProps) {
...
export default TaxConfigurationsPage;
