...
export interface NotificationTemplatesPageProps {
...
export function NotificationTemplatesPage({ data: propData, onAdd, onUpdate, onDelete }: NotificationTemplatesPageProps) {
  ...
  return (
    <div>
      ...
      >
        ...
        {modal && (
          <Modal title={`${modal.mode === "add" ? "Add" : "Edit"} — Notification Templates`} onClose={() => setModal(null)}>
            ...
            <div style={{ marginBottom: 12 }}>
              <label style={{ display: "block", fontSize: 11, fontWeight: 600, color: T.textSoft, textTransform: "uppercase", marginBottom: 5 }}>Channel</label>
              <input
                style={{ width: "100%", padding: "8px 10px", border: `1px solid ${T.border}`, borderRadius: 4, fontSize: 13, boxSizing: "border-box" }}
        ...
        {toDelete && (
          <Modal title="Delete — Notification Templates" onClose={() => setToDelete(null)}>
